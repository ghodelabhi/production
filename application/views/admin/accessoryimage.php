		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading"><?php echo $title;?> <a href="<?php echo site_url(); ?>admin/accessory/add-edit-image" class="btn btn-primary flt_right">Add</a></div>
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data2.json" >
						    ...
						    <?php $c=1; foreach ($getAccessory as $getAccessorys) { ?>
						    	<tr>
						        <td><?php echo $c; ?></td>
						        <td><?php echo $getAccessorys->image; ?></td>
